...
\title[Metaheuristic optimization for intraday futures]{Combining Technical Indicators and Equal-Budget Metaheuristic Optimization for Short-Term Mini-Index Futures Prediction}
...
\input{sections/ijcnn_introduction}
\input{sections/ijcnn_related_work}
\input{sections/ijcnn_methodology}
\input{sections/ijcnn_results}
\input{sections/ijcnn_conclusion}
