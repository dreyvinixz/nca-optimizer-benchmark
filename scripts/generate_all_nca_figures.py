...
def main():
    ...
    # -------------------------------------------------------------
    # FIGURE 1: Sequential Temporal Split Protocol (FIXED LEGEND BUG)
    # -------------------------------------------------------------
    fig, ax = plt.subplots(figsize=(8.5, 3.0), dpi=300)
    ...
    ax.set_title('Sequential Temporal Partitioning Protocol (shuffle = False)', fontweight='bold', pad=12)
    ax.legend(loc='upper center', bbox_to_anchor=(0.5, 1.25), ncol=3, frameon=True, facecolor='#ffffff', edgecolor='#cccccc')
    ax.set_xlim(0, 15057)
    ...
    ax.set_title('Overview of Proposed Optimizer Benchmark Framework', fontweight='bold', fontsize=11, y=0.98)
    plt.tight_layout()
    ...
    ax.set_title('Optimizer Validation Fitness Trajectories (20 Independent Seeds)', fontweight='bold')
    ...
    axes[0].set_title('Out-of-Sample MCC Distribution', fontweight='bold')
    ...
    axes[1].set_title('Out-of-Sample Accuracy (%)', fontweight='bold')
    ...
    ax.set_title('Out-of-Sample Financial Backtest Equity Curves', fontweight='bold')
    ax.grid(True, linestyle=':', alpha=0.6)
